...
## Synopsis
Les visiteurs empruntent ce sentier illuminé. Lors de leurs déplacements, ceux-ci se rendent compte que le sentier interagit à leurs passages; les lumières commencent à se déplacer et les sons se déclenchent pour donner un sentiment serein. Dans le chemin lumineux se trouve des codes QR qui, une fois scannés, présentent une animation.
...
## Lumières et visuels 
L'aspect visuel de notre projet est très important pour l'immersion dans notre univers. Et, pour réussir à cela, voilà comment nous allons procéder.
- Une vidéo sera créée sur After Effects. [Pour voir la vidéo en question](https://cmontmorency365-my.sharepoint.com/:v:/g/personal/1908085_cmontmorency_qc_ca/EYhM2eN1gKNFnEMKhKpbvlEBiTKdB7QscrqFWLtpgvSMGA). C'est encore au stade expérimental. 
- Cette vidéo contrôlera les lumières grâce à MadMapper. 
...
- [Premier échantillon]("https://soundcloud.com/maxime-des-lauriers)

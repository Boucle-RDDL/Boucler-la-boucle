...
## Semaine 9
Cette semaine fut satisfaisante!
![lumière rose](medias/lumière_rose.png)

Tout d'abord, il a fallu règler les dernier problèmes liés aux lumières.
![lumière chemin nuit](medias/lumière_chemin_nuit.png)

Ensuite, il nous fallait règler nos problèmes de câbles.
...
Nous sommes vraiment content du résultat de notre projet et attendons avec impatience que des personnes viennent visiter!
